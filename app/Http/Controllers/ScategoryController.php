...
class ScategoryController extends Controller
{
    ...
    {
        $scategories = Scategory::with('categories')->get();
        return $scategories;
    }
    ...
    {
        $Scategorie= Scategory::where('categorieID', $idcat)->with('categories')->get();
        return response()->json($Scategorie);
    }
}
